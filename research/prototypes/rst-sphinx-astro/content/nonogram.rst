...
LaTeX tables. :numref:`fig-nonogram-heart` combines them into one accessible,
responsive illustration with aligned hints and a restrained solution color.
...
For a line with runs :math:`2,3,1`, the model posts the regular language
