...
`GECODE_PREFIX=/path/to/install`. The example validation tooling also uses
test sources from `GECODE_ROOT` and rebuilds Gecode for the custom variable examples.
